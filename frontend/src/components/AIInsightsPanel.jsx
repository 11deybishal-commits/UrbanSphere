...
const AIInsightsPanel = ({ building, onClose }) => {
  ...
  return (
    <motion.div
      ...
      className="absolute right-0 top-0 bottom-0 w-96 bg-dark/95 backdrop-blur-xl border-l border-primary/30 overflow-y-auto z-40"
    >
      <div className="p-6">
        ...
        <div className="space-y-4">
          <InfoCard
            title={building.name}
            subtitle={building.type.toUpperCase()}
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="p-4 rounded-xl bg-white/5 border border-white/10">
                <h3 className="text-sm font-semibold mb-2">Building Details</h3>
                <div className="space-y-1 text-sm text-gray-300">
                  <p>Address: {building.metadata?.address || 'N/A'}</p>
                  <p>Floors: {building.metadata?.floors || 'N/A'}</p>
                  <p>Year Built: {building.metadata?.yearBuilt || 'N/A'}</p>
                  <p>Capacity: {building.metadata?.capacity || 'N/A'}</p>
                </div>
              </div>
            </>
          )}
